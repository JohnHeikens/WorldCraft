...
{//y+ = front
	...
	flipper0 = DBG_NEW bodypart(&body, vec3(-sideflipperoffset.x, sideflipperoffset.y, sideflipperoffset.z), sideflippersize, vec3(sideflippersize.x, sideflipperjoint.y, sideflipperjoint.z), { rotation() });
	flipper1 = DBG_NEW bodypart(&body, vec3(sideflipperoffset.x, sideflipperoffset.y, sideflipperoffset.z), sideflippersize, vec3(0, sideflipperjoint.y, sideflipperjoint.z), { rotation() });
	...
	backflipper0 = DBG_NEW bodypart(&body, backflipper0offset, backflipper0size, backflipper0joint, { rotation() });
	...
	backflipper1 = DBG_NEW bodypart(&body, backflipper1offset, backflipper1size, backflipper1joint, { rotation() });
