...
extern Image* fullhunger;
extern Image* halfhunger;
extern Image* emptyhunger;
...
public:
	...
	inline static void LoadMod(std::wstring filename) 
	{
		...
		fullhunger = Image::FromFile(folder + L"fullhunger.bmp", true);
		halfhunger = Image::FromFile(folder + L"halfhunger.bmp", true);
		emptyhunger = Image::FromFile(folder + L"emptyhunger.bmp", true);
		//load major blocks
