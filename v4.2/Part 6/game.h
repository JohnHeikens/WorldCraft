...
constexpr fp sneakangle = math::PI / 6;//player is rotated 1/12th of a circle forward

constexpr int version = 2;//current version:2
...
void Delete();
void Initialize();
bool Pressed(int key, const bool falseifnotfocus = true);
